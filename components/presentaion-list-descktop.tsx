...
const PresentaionListDesktop: React.FC = () => {
	...
	return (
		<motion.ul
			...
			className="flex text-xl flex-col shadow-lg lg:justify-between lg:items-center w-full h-full lg:flex-row bg-yellow-500 md:p-7 lg:p-16 rounded-3xl"
		>
			<li className="flex flex-col space-y-8">
				<h1 className="font-bold">{t("presentaionlistheaderone")}</h1>
				<p className=" text-sm font-light w-44">
			...
			<li className="relative space-y-6 z-10 text-white flex flex-col after:content-[''] lg:after:w-64 xl:after:w-80 lg:after:h-80 xl:after:h-96 after:bg-slate-900 after:absolute after:rounded-2xl after:-z-10 after:left-1/2 after:-translate-x-1/2 after:top-[50%] after:-translate-y-1/2">
				<HandIcon />
